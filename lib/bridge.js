...
module.exports = (function () {
  "use strict";
  var ws = require('node-websocket-server-master')
  ...
  workerMan = {
    ...
    createWorker: function () {
      var id = this.getId()
        , worker = spawn('phantomjs', [__dirname + '/worker.js', id, '--disk-cache=true'])
        , that = this;
  ...
  function init(opts) {
    ...
    opts.onDied && emitter.on('died', opts.onDied);
  }
